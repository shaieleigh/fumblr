...
class PersonalModalButton extends React.Component {
  ...
  render() {
    return (
      <>
        <button className='personalInfo' onClick={this.handleClick}><svg className='personalModalButton' width="1em" height="1em" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
